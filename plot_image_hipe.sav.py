...
xrange=[crval1-(crpix1-0.5)*cdelt1/cosd*0.5,\
 crval1-(crpix1-naxis1-0.5)*cdelt1/cosd*0.5]
myPlot.xrange=xrange
yrange=[crval2-(crpix2-0.5)*cdelt2*0.5,\
 crval2-(crpix2-naxis2-0.5)*cdelt2*0.5]
...
# Parallels every 1', meridians every 10"
deltaDec=60.0/3600.0
deltaRa=1.0*15.0/3600.0*10.0
