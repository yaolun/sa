    ...
    for o in objlist:
        ...
        if o in spireobj:
            ...
            if (o in pacsobj) and (o != 'IRS46') and (o != 'HH100') and (o != 'V1735Cyg'):
                ...
                print o, flux_pacs[(wl_pacs > 180) & (wl_pacs < max(wl_pacs))],\
                        (flux_pacs[(wl_pacs > 180) & (wl_pacs < max(wl_pacs))]-flux_spire[(wl_spire > min(wl_spire)) & (wl_spire < 210)])/flux_pacs[(wl_pacs > 180) & (wl_pacs < max(wl_pacs))]
                diff.append(float((flux_pacs[(wl_pacs > 180) & (wl_pacs < max(wl_pacs))]-flux_spire[(wl_spire > min(wl_spire)) & (wl_spire < 210)])/flux_pacs[(wl_pacs > 180) & (wl_pacs < max(wl_pacs))]))
