    ...
    #
        ...
        if write_out:
            ...
            if 'turning_pt' in locals():
                ...
                if type(turning_pt) != list:
                    foo.write(objname+', '+str(turning_pt)+'\n')
                else:
                    foo.write(objname+', '+','.join(map(str, turning_pt))+'\n')
                foo.close()
...
if os.path.exists('/Volumes/SD-Mac/Google Drive/research/cops-spire/rotational_diagrams/corrected/co_rotational_temp_optcor.txt'):
    os.remove('/Volumes/SD-Mac/Google Drive/research/cops-spire/rotational_diagrams/corrected/co_rotational_temp_optcor.txt')
if os.path.exists('/Volumes/SD-Mac/Google Drive/research/cops-spire/rotational_diagrams/corrected/co_breakpoints_optcor.txt'):
    os.remove('/Volumes/SD-Mac/Google Drive/research/cops-spire/rotational_diagrams/corrected/co_breakpoints_optcor.txt')
if os.path.exists('/Volumes/SD-Mac/Google Drive/research/cops-spire/rotational_diagrams/corrected/co_rotational_fixtemp_optcor.txt'):
    os.remove('/Volumes/SD-Mac/Google Drive/research/cops-spire/rotational_diagrams/corrected/co_rotational_fixtemp_optcor.txt')

# if os.path.exists('/Volumes/SD-Mac/Google Drive/research/cops-spire/rotational_diagrams/corrected/three_temp/co_rotational_temp_optcor.txt'):
#     os.remove('/Volumes/SD-Mac/Google Drive/research/cops-spire/rotational_diagrams/corrected/three_temp/co_rotational_temp_optcor.txt')
# if os.path.exists('/Volumes/SD-Mac/Google Drive/research/cops-spire/rotational_diagrams/corrected/three_temp/co_breakpoints_optcor.txt'):
#     os.remove('/Volumes/SD-Mac/Google Drive/research/cops-spire/rotational_diagrams/corrected/three_temp/co_breakpoints_optcor.txt')
# if os.path.exists('/Volumes/SD-Mac/Google Drive/research/cops-spire/rotational_diagrams/corrected/three_temp/co_rotational_fixtemp_optcor.txt'):
#     os.remove('/Volumes/SD-Mac/Google Drive/research/cops-spire/rotational_diagrams/corrected/three_temp/co_rotational_fixtemp_optcor.txt')
...
for o in obj_list:
    print o
    pop_dia_1d(o, '/Volumes/SD-Mac/Google Drive/research/cops-spire/rotational_diagrams/corrected/',
